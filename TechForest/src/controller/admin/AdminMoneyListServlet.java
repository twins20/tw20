...
public class AdminMoneyListServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ilist =  as.adminIndexPMoneyChkList();		
		request.setAttribute("ilist", ilist);
				
		ArrayList<Map<String, Object>> ilist1 = (ArrayList<Map<String, Object>>) request.getAttribute("ilist"); 
		
		for(Map<String, Object> hashmap : ilist1){
