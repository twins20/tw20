...
<p class="cmemTitle">답변 수정</p>	
	<form id="cmemberQnaReplyWriteAction" name="cmemberQnaReplyWriteAction" class="form-horizontal cmemberQnaReplyWriteAction" 	action="<%=request.getContextPath()%>/CMemberQnaReplyWrite_Action.do" method="post">
 		...
 		<div class="form-group">
    			...
    			<div class="col-sm-9">
    				<input class="form-control" type="text" name="title" id="title" value="<%=bvo.getTitle()%>">
   				</div>
 		</div>
 		<div class="form-group">
   	 		<label for="contents" class="col-sm-3 control-label">내용</label>
    			<div class="col-sm-9">
    				<textarea class="form-control" type="text" name="contents" id="contents" rows="15" ><%=bvo.getContents()%></textarea>
   				</div>
 		</div>
		<center>
