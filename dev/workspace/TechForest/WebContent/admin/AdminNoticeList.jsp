...
<c:set var="pagingUrl" value="/AdminNoticeList.do"/>
...
%>		
	  <div class="clearFix">
	    ...
	    <div class="col col6_2"><a href="<%=request.getContextPath()%>/AdminNoticeConServlet?bIdx=<%= vo.getbIdx()%>"><%= vo.getTitle()%></a></div>
	    <div class="col col6_3"><%= vo.getCate()%></div>	 
	    <div class="col col6_4"><%= statusView%></div>	    
	    <div class="col col6_5"><%= vo.getInsDate()%></div>	    
	    <div class="col col6_6">
	    	<a href="<%=request.getContextPath()%>/AdminNoticeMod.do?bIdx=<%= vo.getbIdx()%>"><%= modBtn%></a>
	    	<a href="<%=request.getContextPath()%>/AdminNoticeDel_Action.do?bIdx=<%= vo.getbIdx()%>"><%= delBtn%></a></div>
	  </div>	  
<%
		}
%>
<!-- 페이징 처리 부분 -->
	...
	<div>
		<a href="<%=request.getContextPath()%>/AdminNoticeWrite.do"><button class="btn btn-primary pull-right">글쓰기</button></a>
	</div>
</div>
