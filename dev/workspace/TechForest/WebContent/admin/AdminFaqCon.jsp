...
<div class="Wrapper">
	...
	<div>
		<a href="<%=request.getContextPath()%>/AdminFaqDel_Action.do?bIdx=<%= vo.getbIdx()%>"><button class="btn btn-primary pull-right">삭제</button></a>
	</div>
	<div>
		<a href="<%=request.getContextPath()%>/AdminFaqMod.do?bIdx=<%= vo.getbIdx()%>"><button class="btn btn-primary pull-right">수정</button></a>
	</div>
	<div>
		<a href="<%=request.getContextPath()%>/AdminFaqList.do"><button class="btn btn-primary pull-right">목록</button></a>
	</div>
</div>
