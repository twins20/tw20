...
<div class="Wrapper">
	...
	<div>
		<a href="<%=request.getContextPath()%>/AdminQnaDel_Action.do?bIdx=<%= vo.getbIdx()%>"><button class="btn btn-primary pull-right">삭제</button></a>
	</div>
	<div>
		<a href="<%=request.getContextPath()%>/AdminQnaMod.do?bIdx=<%= vo.getbIdx()%>"><button class="btn btn-primary pull-right">수정</button></a>
	</div>
	<div>
