...
/**
 * Servlet implementation class FaqCommSubModServlet_Action
 */
@WebServlet("/FaqCommSubModServlet_Action")
public class FaqCommSubModServlet_Action extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public FaqCommSubModServlet_Action() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		PageRedirect pr = new PageRedirect(true,"/FaqCon.do?bIdx="+bIdx+"&commIdx="+ocommIdx+"", request, response);
	*/
	}
