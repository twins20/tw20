...
/**
 * Servlet implementation class NoticeCommModServlet_Action
 */
@WebServlet("/NoticeCommModServlet_Action")
public class NoticeCommModServlet_Action extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public NoticeCommModServlet_Action() {
        super();
