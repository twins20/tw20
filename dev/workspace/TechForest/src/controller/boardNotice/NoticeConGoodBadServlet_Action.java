...
/**
 * Servlet implementation class NoticeConGoodBadServlet_Action
 */
@WebServlet("/NoticeConGoodBadServlet_Action")
public class NoticeConGoodBadServlet_Action extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public NoticeConGoodBadServlet_Action() {
        super();
