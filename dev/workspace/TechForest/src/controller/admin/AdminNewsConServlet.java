...
@WebServlet("/AdminNewsConServlet")
public class AdminNewsConServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
   
    public AdminNewsConServlet() {
        super();
...
//		}
		...
		PageRedirect pr = new PageRedirect(false, "/admin/AdminNewsCon.jsp", request, response);	
	}
