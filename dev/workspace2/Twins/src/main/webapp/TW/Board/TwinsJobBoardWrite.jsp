...
function check() {
	...
	form0922.action="${pageContext.request.contextPath}/twins/jbWriteActionController${pageMaker.idxTotalMakeSearch(page, jmv.jmidx, jmv.jmname)}";
...
<input type="hidden" name="jboidx" value="0">  <!--  MaxBIDX()에서 실제값을 할당함 /IDX/ --> 
...
<tr>
  ...
  <td class=col2><textarea class=jbwriter name="jbwriter" cols = 30 rows=1 
  						   onkeyup="checkLength(this,15)">${jmv.jmname}</textarea>
